...
import { LeftSection} from './PresentationStyle.jsx';
    ...
    <>
        <Section row nopadding>
            <LeftSection>
                ...
                <SectionText>
                    I&#39;m Dante Julien. I&#39;m an Student developer from Marseille, I&#39;m still learning in JS,
                    SQL, Java etc... Currently, I am working in React and Angular.
                    I&#39;m passionate about learning new thing and participate in project
                </SectionText>
                <Button onClick={(e) => {
                    e.preventDefault();
